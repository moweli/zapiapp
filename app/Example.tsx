...
import { features, tiers, classNames, faqs, footerNavigation } from "./page";
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center">
              ...
              <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                Transform Your Business with Custom Web Applications Tailored to
                Your Needs
              </p>
              <p className="mt-6 text-lg leading-8 text-gray-600">
                At ZapiApp Solutions, we specialise in creating bespoke web
                applications that are designed to streamline your business
                operations and drive growth. Our experienced team of developers
                and designers will work closely with you to understand your
                unique needs and deliver a solution that exceeds your
                expectations.
              </p>
            </div>
          </div>
